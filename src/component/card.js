                            ...
                            <MDBCarouselItem itemId="1">
                                <MDBView>
                                    <MDBRow>
                                        <MDBCol md='3'>
                                            <MDBCard>
                                                <MDBCardImage className="img-fluid" src={require('../img/card/card2.jpeg')}
                                                    waves />
                                                <MDBCardBody>
                                        ...
                                        <MDBCol md='3'>
                                            <MDBCard >
                                                <MDBCardImage className="img-fluid" src={require('../img/card/7.jpeg')}
                                                    waves />
                                                <MDBCardBody>
                                                    <MDBCardTitle>@oddadrendy</MDBCardTitle>
                                                    <MDBCardText>" Thanks oddi karena custommu aku bebas melakukan apa aja kualitas terbaik"
                                        ...
                                        <MDBCol md='3'>
                                            <MDBCard>
                                                <MDBCardImage className="img-fluid" src={require('../img/card/5.jpeg')}
                                                    waves />
                                                <MDBCardBody>
                            ...
                            <MDBCarouselItem itemId="2">
                                <MDBView>
                                    <MDBRow>
                                        <MDBCol md='3'>
                                            <MDBCard>
                                                <MDBCardImage className="img-fluid" src={require('../img/card/8.jpeg')}
                                                    waves />
                                                <MDBCardBody>
