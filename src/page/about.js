      ...
      <div style={{ margin: "auto", backgroundColor: "with" }}>
        ...
        <div class="d-flex bd-highlight">
          ...
          <div class="p-5 w-50 bd-highlight" style={{ fontSize: "20px" }}>
            ...
            Kenapa kalian harus memilih custom clothing? Sesuai campaign yang selalu kami suarakan, yaitu BE YOURSELF!, kami selalu berusaha membuat konsumen kami tampil lebih percaya diri dengan pakaian yang ia kenakan. Karena kami mampu
            memberi kamu kebebasan dalam memilih warna, size, hingga model pakaian kamu sendiri, sehingga kamu akan tampil lebih eksklusif.
          </div>
        </div>
      </div>
    );
