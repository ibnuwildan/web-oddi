      ...
      <div class="p-5 " style={{ fontSize: "20px" }}>
        ...
        <MDBCardHeader color="cyan darken-3">
          <h3 className="font-weight-bold" style={{ textAlign: "center" }}>
            INFORMASI KAOS CUSTOM{" "}
          </h3>
        </MDBCardHeader>
        <h4 className="font-weight-bolder" style={{ paddingTop: 10 }}>
          jenis kaos oddi
        </h4>
        ...
        <MDBRow>
          <MDBCol md="6">
            ...
            <p>Ukuran kaos Cotton Combed 20s mengikuti ukuran lokal, sedangkan New States Apparel mengikuti ukuran asian fit. Detail ukuran bisa dilihat pada tabel di bawah ini.</p>
            <MDBTable>
        ...
        <MDBRow>
          <MDBCol md="6">
            <p className="font-weight-bolder" style={{ paddingTop: 10 }}>
              Cotton Combed 20s, 24s dan 30s lengan pendek
            </p>
          ...
          <MDBCol md="6">
            <p className="font-weight-bolder" style={{ paddingTop: 10 }}>
              Cotton Combed 20s, 24s dan 30s lengan panjang
            </p>
            <p>*harga sudah termasuk kaos dan design</p>
            <MDBTable>
              <MDBTableHead className="font-weight-bolder" color="cyan darken-3">
